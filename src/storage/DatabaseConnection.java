...
public class DatabaseConnection {
     ...
     public static ArrayList<Pizza> getMenuKortFromDB() throws Exception{
        ...
        statement.executeUpdate("INSERT INTO ordre(afhent, oprettet, cname, tlfno) VALUES "
                + "('" + LocalDate.now() + " " + bestilling.getAfhentningsTidspunkt() +":00" 
                        + "', '" + LocalDate.now() + "'," + "'" + bestilling.getCname() + "'," + bestilling.getTlfno() + ");");
        
        }
          
          public static void removeOrdre(Bestilling bestilling) throws Exception{
        ...
        statement.executeUpdate("ALTER TABLE ordre DROP field1");
          }
}
